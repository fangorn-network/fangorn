...
// }
export function deriveVaultId(passwordHash, owner) {
    return keccak256(encodeAbiParameters(parseAbiParameters("bytes32, address"), [
        passwordHash,
        owner,
    ]));
}
...
export async function poseidon1Hash(input) {
    const poseidonCircuit1 = poseidon1Circuit;
...
export async function poseidon2Hash(left, right) {
    const poseidonCircuit2 = poseidon2Circuit;
...
export function addressToBytes32Array(address) {
