...
export declare function deriveVaultId(passwordHash: `0x${string}`, owner: Address): `0x${string}`;
export declare function poseidon1Hash(input: bigint): Promise<bigint>;
export declare function poseidon2Hash(left: bigint, right: bigint): Promise<bigint>;
