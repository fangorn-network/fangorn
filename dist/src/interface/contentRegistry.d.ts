import { type PublicClient, type WalletClient, type Address, type Hash, Hex } from "viem";
...
export declare const CONTENTREGISTRY_ABI: readonly [{
    readonly name: "registerDataSource";
    ...
    readonly name: "getOwnedDataSources";
    readonly type: "function";
    readonly stateMutability: "view";
    readonly inputs: readonly [{
        readonly name: "owner";
    ...
    readonly name: "DataSourceCreated";
    readonly type: "event";
    readonly inputs: readonly [{
        readonly name: "id";
        readonly type: "bytes32";
    ...
    readonly name: "DataSourceUpdated";
    readonly type: "event";
    readonly inputs: readonly [{
        readonly name: "id";
        readonly type: "bytes32";
...
export declare class ContentRegistry {
    ...
    constructor(contractAddress: Address, publicClient: PublicClient, walletClient: WalletClient);
    ...
    registerDataSource(name: string): Promise<{
        hash: Hash;
        vaultId: `0x${string}`;
    }>;
    updateVault(id: `0x${string}`, newRoot: `0x${string}`, newManifestCid: string): Promise<Hash>;
    /**
