...
// import { FieldInput, PublishRecord } from "./roles/old_publisher/types.js";
...
//                     commitCid: commit1,
//                     root: root1,
//                     schemaId: await testbed.getDelegatorFangorn().getPublisherRegistry().schemaId(repoSchema),
//                     datasetName,
//                     expectedParent: undefined,
//                 }),
...
//             const owner = testbed.getDelegatorAddress();
//             const schemaId = await testbed.getDelegatorFangorn().getPublisherRegistry().schemaId(repoSchema);
