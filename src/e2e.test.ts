...
describe("ZK-gated decryption", () => {
	...
	beforeAll(async () => {
		...
		// 	console.log("Deploying Paywall Contract");
		// 	const deployment = await deployContract({ account: delegatorAccount, contractName: "Paywall" });
		// 	usdcContractAddress = deployment.address;
		// }
