...
// Cross-publisher identity (docs/archive/CROSS_PUBLISHER_LINKING.md, Phase 0).
...
// Composed View (docs/archive/CROSS_PUBLISHER_LINKING.md, Phase 1).
//
...
// Linkset (docs/archive/CROSS_PUBLISHER_LINKING.md, Phase 2).
//
