...
import { type SchemaDefinition, type ResolvedBundle } from "../../schema/types";
import { type MetadataStorage } from "../../../providers/storage/types";
import { type SchemaRegistry } from "../../../registries/schema-registry";
import { type BundleManifest, type BundleNode, type FieldInput, type PublishRecord } from "../types";
import { type ManifestBuilder, type ChunkDraft, type ChunkRef, type BuildContext, type ResolvedSchemaShape } from "./types";
...
export class BundleBuilder implements ManifestBuilder<BundleUploadInput, BundleManifest> {
    ...
    private async resolveDefs(bundle: ResolvedBundle): Promise<Map<string, SchemaDefinition>> {
